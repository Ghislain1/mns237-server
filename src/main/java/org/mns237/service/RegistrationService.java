...
import org.mns237.dto.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String link = "http://localhost:8888/api/v3/registration/confirm?token=" + token;
        emailSender.send(
            request.getEmail(),
    ...
    private Object buildEmail(String name, String link) {
